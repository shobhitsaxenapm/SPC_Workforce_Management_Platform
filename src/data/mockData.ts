...
export const mockCandidates: Candidate[] = [
  ...
  },
  {
    ...
    email: 'rahul.s.applicant@email.com',
    ...
    resumeUrl: 'https://example.com/resume/rahul_sharma.pdf',
    professionalSummary: 'Assistant seeking new opportunities.',
    employmentHistory: [],
    languages: ['English', 'Hindi'],
  },
  {
    ...
    currentLocation: 'Gurugram',
    totalExperience: '2 Years',
    currentCompany: 'XYZ Logistics',
    currentRole: 'Warehouse Associate',
    skills: ['Inventory'],
    education: '12th Pass',
    currentSalary: '₹2.2 LPA',
    expectedSalary: '₹3.0 LPA',
    noticePeriod: 'Immediate',
    source: 'SPC Careers Website',
    duplicateStatus: 'None',
    createdAt: '2026-07-09T14:30:00Z',
    resumeUrl: 'https://example.com/resume/anjali_verma.pdf',
    professionalSummary: 'Warehouse worker.',
    employmentHistory: [],
    languages: ['Hindi'],
  },
  {
    ...
    education: '10th Pass',
    currentSalary: 'N/A',
    expectedSalary: '₹1.5 LPA',
    noticePeriod: 'Immediate',
    source: 'SPC Careers Website',
    duplicateStatus: 'None',
    createdAt: '2026-07-08T09:00:00Z',
    resumeUrl: 'https://example.com/resume/priya_patel.pdf',
    professionalSummary: 'Fresher looking for a job.',
    employmentHistory: [],
    languages: ['Hindi'],
  }
];
...
export const mockApplications: Application[] = [
  ...
  },
  {
    ...
    projectId: 'r1',
    currentStage: 'New',
    appliedDate: '2026-07-10T10:00:00Z',
    source: 'SPC Careers Website',
    matchScore: 85,
  ...
  },
  {
    ...
    appliedDate: '2026-07-08T09:00:00Z',
    source: 'SPC Careers Website',
    matchScore: 40,
  ...
  {
    id: 'app11',
    candidateId: 'can10', // Existing candidate
    jobId: 'j3', // Different job
    projectId: 'r2',
    currentStage: 'Under Review',
    appliedDate: '2026-07-11T09:00:00Z',
    source: 'SPC Careers Website',
    matchScore: 65,
    lastActivity: '2026-07-11T10:00:00Z'
  }
];
